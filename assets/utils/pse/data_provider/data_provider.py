...
import numpy as np
from assets.utils.utils_tool import logger
from assets.utils.data_provider.data_util import GeneratorEnqueuer
...
def generator(input_size=512, batch_size=32,
    ...
    :return:
    '''
    image_list = np.array(get_files(['jpg', 'png', 'jpeg', 'JPG', 'tif']))
